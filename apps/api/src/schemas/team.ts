...
export const updateTeamByIdSchema = z.object({
  ...
  logoUrl: z
    ...
    .refine((url) => url.includes("kerna.ai"), {
      message: "logoUrl must be a kerna.ai domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the team's logo image. Must be hosted on kerna.ai domain",
      example: "https://cdn.kerna.ai/logos/acme-corp.png",
    }),
...
export const teamMemberResponseSchema = z.object({
  ...
  avatarUrl: z.string().url().nullable().openapi({
    ...
    example: "https://cdn.kerna.ai/avatars/john-doe.png",
  }),
});
