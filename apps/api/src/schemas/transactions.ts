        ...
        connection: z
          .object({
            ...
            logoUrl: z.string().nullable().openapi({
              ...
              example: "https://cdn.kerna.ai/logos/chase-bank.png",
            }),
          })
          .openapi({
            description:
            ...
            example: {
              ...
              name: "Chase Bank",
              logoUrl: "https://cdn.kerna.ai/logos/chase-bank.png",
            },
          }),
      })
      .openapi({
...
export const transactionAttachmentPreSignedUrlResponseSchema = z.object({
  url: z.string().url().openapi({
    ...
    example:
      "https://service.kerna.ai/storage/v1/object/sign/vault/transactions/receipt.pdf?token=abc123&expires=1640995200",
  }),
